...
export function EarningsChart({ role = "writer", data }: EarningsChartProps) {
  ...
  return (
    <Card className="@container/card px-4 lg:px-6">
      <CardHeader>
        <CardTitle>{role === "bidder" ? "Spending Overview" : "Earnings Overview"}</CardTitle>
        <CardDescription>
          <span className="hidden @[540px]/card:block">Track earnings and spending over time</span>
      ...
      <CardContent className="px-2 pt-4 sm:px-6 sm:pt-6">
        <ChartContainer config={chartConfig} className="aspect-auto h-[250px] w-full">
          <AreaChart data={filteredData}>
            ...
            />
            <Area dataKey="spending" type="natural" fill="url(#fillSpending)" stroke="var(--color-spending)" />
            <Area dataKey="earnings" type="natural" fill="url(#fillEarnings)" stroke="var(--color-earnings)" />
          </AreaChart>
        </ChartContainer>
      </CardContent>
    </Card>
